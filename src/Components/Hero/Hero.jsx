export default function Hero() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-black via-[#050816] to-[#0a0f2c] flex items-center justify-center px-6">
            ...
            <div className="text-center max-w-3xl">
                ...
                <div className="mt-8 flex justify-center gap-4">
                    ...
                    {/* Primary Button */}
                    <button className="px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg hover:opacity-90 transition">
                        View Projects →
                    </button>
